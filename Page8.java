...
public	ImageIcon img;
	...
	l1=new JLabel("Choose Expressway");
	...
	b1 = new JButton("Dhaka-express");
		...
		b2 = new JButton("Rawalpindi express");
		b2.setFont(new Font("Comic Sans MS",Font.BOLD,15));
		b2.setForeground(Color.black);
		b2.setBounds(170, 250, 120, 25);
		label.add(b2);
		
		b3 = new JButton("Kolkata express");
		b3.setFont(new Font("Comic Sans MS",Font.BOLD,15));
		b3.setForeground(Color.black);
		b3.setBounds(355, 250, 120, 25);
		label.add(b3);
		
			b4 = new JButton("Norail express");
